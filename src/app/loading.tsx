  ...
  return (
    <div className="min-h-dvh flex flex-col items-center justify-center gap-6">
      <div className="relative">
        ...
        <div className="absolute inset-0 blur-2xl bg-primary-container/20 -z-10" />
      </div>
      <div className="h-1 w-32 rounded-full bg-white/5 overflow-hidden">
        <div className="h-full w-1/2 bg-primary-fixed rounded-full animate-[loading_1.2s_ease-in-out_infinite]" />
      </div>
